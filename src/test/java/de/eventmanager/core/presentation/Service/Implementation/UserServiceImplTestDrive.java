...
public class UserServiceImplTestDrive {
    ...
    void loginUser() {
        ...
        System.out.println(userServiceImpl.loginUser("dele00003@htwsaar.de", "Password123").get());

        assertTrue(userServiceImpl.loginUser("dele00003@htwsaar.de", "Password123").isPresent());
    }
}
