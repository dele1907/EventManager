...
*/
    ...
    public static int getEventEndYear(String eventName) {
        ...
        try (Connection connection = DatabaseConnector.connect()) {
            ...
            Result<Record1<Integer>> result = create.select(DSL.field("(strftime('%G', eventEnd))", Integer.class))
                    .from("events")
                    .where(DSL.field("eventName").eq(eventName))
                    .fetch();
    ...
    public static int getEventEndMonth(String eventName) {
        int month = 0;
        ...
        try (Connection connection = DatabaseConnector.connect()) {
            ...
            Result<Record1<Integer>> result = create.select(DSL.field("(strftime('%m', eventEnd))", Integer.class))
                    .from("events")
                    .where(DSL.field("eventName").eq(eventName))
                    .fetch();
    ...
    public static int getEventEndDay(String eventName) {
        int day = 0;
        ...
        try (Connection connection = DatabaseConnector.connect()) {
            ...
            Result<Record1<Integer>> result = create.select(DSL.field("(strftime('%d', eventEnd))", Integer.class))
                    .from("events")
                    .where(DSL.field("eventName").eq(eventName))
                    .fetch();
    ...
    public static int getEventEndHour(String eventName) {
        int hour = 0;
        ...
        try (Connection connection = DatabaseConnector.connect()) {
            ...
            Result<Record1<Integer>> result = create.select(DSL.field("(strftime('%H', eventEnd))", Integer.class))
                    .from("events")
                    .where(DSL.field("eventName").eq(eventName))
                    .fetch();
    ...
    public static int getEventEndMinute(String eventName) {
        int minute = 0;
